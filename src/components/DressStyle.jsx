...
const DressStyle = () => {
    return (
      <div className="w-full mx-auto max-w-[1240px] my-20 bg-[#F0F0F0] rounded-[40px] max-xl:px-4">
        <CustomHeading
          customClass="uppercase pt-[70px] pb-[64px] max-lg:py-[50px] max-md:py-10 max-sm:py-7"
